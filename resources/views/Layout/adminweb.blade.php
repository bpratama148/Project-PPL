                ...
                <div class="container main-menu">
                    <div class="row align-items-center justify-content-between d-flex">
                      ...
                      <nav id="nav-menu-container">
                        <ul class="nav-menu">
                          <li class="menu-active"><a href="/web">Home</a></li>
                          <li><a href="/admin-koiweb">About Koi</a></li>
                          <li><a href="">Diagnosa</a></li>
                          <li><a href="/admin-pakarweb">Tanya Pakar</a></li>
                          <li><a href="admin-forum">Forum</a></li>
                          
                          <li class="menu-has-children"><a href="/admin-wgaleri">Gallery</a>  
