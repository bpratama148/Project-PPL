				...
				<div class="container">
					...
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-8 col-md-12">
							...
							<a href="/login" class="primary-btn header-btn text-uppercase">Ketahui Lebih Banyak Tentang Koi</a>
						</div>											
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="active-testimonial-carusel">
							<div class="single-testimonial item">
								<img class="mx-auto" src="{{url('aa/img/t1.png')}}" alt="">
								<p class="desc">
							...
							<div class="single-testimonial item">
								<img class="mx-auto" src="{{url('aa/img/t2.png')}}" alt="">
								<p class="desc">
									Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
								</p>
								<h4>Mark Alviro Wiens</h4>
							...
							<div class="single-testimonial item">
								<img class="mx-auto" src="{{url('aa/img/t3.png')}}" alt="">
								<p class="desc">
									Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
								</p>
								<h4>Mark Alviro Wiens</h4>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i  aria-hidden="true"></i> by <a  target="_blank">Bayu Pratama</a>
